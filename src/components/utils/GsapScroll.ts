...
export function setCharTimeline(
  ...
  if (window.innerWidth > 1024) {
    if (character) {
      // Preserve CSS centering (left: 50% + translateX(-50%)) before timelines start.
      ...
      tl1
        ...
        .fromTo(
          ".character-model",
          { xPercent: -50, x: 0 },
          { xPercent: -50, x: "-25%", duration: 1, immediateRender: false },
          0
        )
...
export function setAllTimeline() {
  ScrollTrigger.getById("career-main")?.kill();
